---
name: tech-learning-authoring
description: Use when adding a topic, subtopic, or post to the tech-learning (Here Be Dragons) repo, enforces the frontmatter shape that doesn't break the YAML parser, cross-linking conventions, voice, length, and the build-verify-commit loop that keeps the site deployable
---
