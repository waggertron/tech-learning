...
Before doing anything else, read `.agents/memory/deep-learn-log.md`.
...
Update `.agents/memory/deep-learn-log.md` with:
...
File: `.agents/memory/deep-learn-log.md` (project-local, git-ignored by default)
