...
- **Code examples**: `npm run validate:code-examples`, `npm run check:react-outputs`, `npm run test:react-outputs`, `npm run test:swift-runner-contract`, `npm run test:swift-runner-service`, `npm run test:swift-repl`, `npm run test:coding-problem-vectors`, `npm run check:coding-problem-vectors`, `npm run test:swift-catalog-contract`, `npm run test:swift-catalog-coverage`, and `npm run check:swift-catalog-coverage`.
