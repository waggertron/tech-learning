...
- **2026-07-13: Swift runner execution foundation and REPL**: Defined the compatibility baseline and accepted architecture for editable Swift execution, proved the exact Swift 6.3.3 executor boundary, and added a versioned browser client contract with a deterministic credential-free mock. `SwiftRepl.astro` adds Swift highlighting, accessible execution and cancellation controls, separate compiler and process channels, explicit Linux evidence, approach-block execution, and a safe unavailable state. Evidence: `docs/swift-browser-runner.md`, `docs/adr/2026-07-13-swift-browser-execution.md`, `docs/spikes/2026-07-13-swift-runner.md`, `docs/swift-runner-local-development.md`, `tools/swift-runner-spike/`, `src/lib/swift-runner/`, `src/components/SwiftRepl.astro`, `tests/swift-runner-spike/`, `tests/swift-runner-contract/`, `tests/swift-repl/`.
