...
- **2026-07-13: Swift runner execution foundation**: Defined the compatibility baseline and accepted architecture for editable Swift execution, proved the exact Swift 6.3.3 executor boundary, and added a versioned browser client contract with a deterministic credential-free mock. The contract distinguishes compiler, runtime, timeout, cancellation, output-limit, rejection, and availability outcomes without treating Linux execution as iOS evidence. Evidence: `docs/swift-browser-runner.md`, `docs/adr/2026-07-13-swift-browser-execution.md`, `docs/spikes/2026-07-13-swift-runner.md`, `docs/swift-runner-local-development.md`, `tools/swift-runner-spike/`, `src/lib/swift-runner/`, `tests/swift-runner-spike/`, `tests/swift-runner-contract/`.
