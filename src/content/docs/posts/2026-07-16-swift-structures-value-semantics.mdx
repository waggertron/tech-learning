...
- **Value and reference models**: The Swift Programming Language chapter [Structures and Classes](https://docs.swift.org/swift-book/LanguageGuide/ClassesAndStructures.html) defines shared capabilities, structure copying, class identity, and copy-on-write collections.
