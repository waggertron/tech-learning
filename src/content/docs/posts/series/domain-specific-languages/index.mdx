...
This guide covers the definition, business cases, design process, concrete examples, gotchas, tool choices, adoption criteria, and operating model for domain-specific languages.
