...
description: "A Claude Code skill that implements 15 learning science patterns — spaced retrieval, curiosity hooks, scaffold-fade, misconception confrontation — to teach any knowledge base deeply, not just superficially."
category: ai
...
**The forward effect.** Being asked a question you cannot answer — guaranteed wrong — still improves subsequent learning from the explanation that follows (d=0.43). The question creates an epistemic gap. The explanation fills it. Without the gap, the explanation encodes shallowly.
