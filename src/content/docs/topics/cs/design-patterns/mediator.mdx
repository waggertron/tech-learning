...
import tsCode from './mediator.ts?raw';
import pyCode from './mediator.py?raw';
import goCode from './mediator.go?raw';
...
<TypeScriptRepl code={tsCode} id="mediator-ts" />
</TabItem>
<TabItem label="Python">
<PythonRepl code={pyCode} id="mediator-py" />
</TabItem>
<TabItem label="Go">
<GoRepl code={goCode} id="mediator-go" />
</TabItem>
</Tabs>
