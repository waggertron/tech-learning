...
import practiceCodeSwift from './039-combination-sum.swift?raw';
import approach1SwiftCode from './039-combination-sum-approach1.swift?raw';
import approach2SwiftCode from './039-combination-sum-approach2.swift?raw';
import approach3SwiftCode from './039-combination-sum-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="039-combination-sum-swift" />
  </TabItem>
</Tabs>
...
<SwiftRepl code={approach1SwiftCode} id="039-combination-sum-approach1-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach2SwiftCode} id="039-combination-sum-approach2-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach3SwiftCode} id="039-combination-sum-approach3-swift" />
</TabItem>
</Tabs>
