...
import practiceCodeSwift from './040-combination-sum-ii.swift?raw';
import approach1SwiftCode from './040-combination-sum-ii-approach1.swift?raw';
import approach2SwiftCode from './040-combination-sum-ii-approach2.swift?raw';
import approach3SwiftCode from './040-combination-sum-ii-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="040-combination-sum-ii-swift" />
  </TabItem>
</Tabs>
...
<SwiftRepl code={approach1SwiftCode} id="040-combination-sum-ii-approach1-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach2SwiftCode} id="040-combination-sum-ii-approach2-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach3SwiftCode} id="040-combination-sum-ii-approach3-swift" />
</TabItem>
</Tabs>
