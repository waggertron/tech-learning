...
import practiceCodeSwift from './332-reconstruct-itinerary.swift?raw';
import approach1SwiftCode from './332-reconstruct-itinerary-approach1.swift?raw';
import approach2SwiftCode from './332-reconstruct-itinerary-approach2.swift?raw';
import approach3SwiftCode from './332-reconstruct-itinerary-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="332-reconstruct-itinerary-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="332-reconstruct-itinerary-approach1-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="332-reconstruct-itinerary-approach2-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="332-reconstruct-itinerary-approach3-swift" />
  </TabItem>
</Tabs>
