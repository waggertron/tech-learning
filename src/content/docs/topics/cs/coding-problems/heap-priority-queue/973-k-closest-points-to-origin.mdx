...
import practiceCodeSwift from './973-k-closest-points-to-origin.swift?raw';
...
import approach1SwiftCode from './973-k-closest-points-to-origin-approach1.swift?raw';
import approach2SwiftCode from './973-k-closest-points-to-origin-approach2.swift?raw';
import approach3SwiftCode from './973-k-closest-points-to-origin-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="973-k-closest-points-to-origin-swift" />
  </TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach1SwiftCode} id="973-k-closest-points-to-origin-approach1-swift" />
</TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach2SwiftCode} id="973-k-closest-points-to-origin-approach2-swift" />
</TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach3SwiftCode} id="973-k-closest-points-to-origin-approach3-swift" />
</TabItem>
</Tabs>
