...
import practiceCodeGo from './1046-last-stone-weight.go?raw';
import practiceCodeSwift from './1046-last-stone-weight.swift?raw';
import approach2PyCode from './1046-last-stone-weight-approach2.py?raw';
import approach2TsCode from './1046-last-stone-weight-approach2.ts?raw';
import approach2GoCode from './1046-last-stone-weight-approach2.go?raw';
import approach1SwiftCode from './1046-last-stone-weight-approach1.swift?raw';
import approach2SwiftCode from './1046-last-stone-weight-approach2.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Go">
    <GoRepl code={practiceCodeGo} id="last-stone-weight-go" />
  </TabItem>
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="1046-last-stone-weight-swift" />
  </TabItem>
</Tabs>
...
func lastStoneWeight(stones []int) int {
    ...
    copy(arr, stones)
    for len(arr) > 1 {           // L1: outer loop, runs up to n-1 times
        sort.Ints(arr)           // L2: O(n log n) per round
        y := arr[len(arr)-1]    // L3: O(1) pop from end
        x := arr[len(arr)-2]    // L4: O(1) pop from end
        arr = arr[:len(arr)-2]
        if x != y {
            arr = append(arr, y-x) // L5: O(1) amortized
        }
    }
...
<TabItem label="Swift">
  <SwiftRepl code={approach1SwiftCode} id="1046-last-stone-weight-approach1-swift" />
</TabItem>
</Tabs>
...
func lastStoneWeight(stones []int) int {
    ...
    for h.Len() > 1 {                    // L3: outer loop, up to n-1 rounds
        ...
        if x != y { heap.Push(&h, y-x) } // L6: O(log n) push remainder
    }
    if h.Len() > 0 { return h[0] }
    return 0
}
...
<TabItem label="Swift">
  <SwiftRepl code={approach2SwiftCode} id="1046-last-stone-weight-approach2-swift" />
</TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="Python">
    <PythonRepl code={approach2PyCode} id="last-stone-weight-approach2-py" />
  </TabItem>
  <TabItem label="TypeScript">
    <TypeScriptRepl code={approach2TsCode} id="last-stone-weight-approach2-ts" />
  </TabItem>
  <TabItem label="Go">
    <GoRepl code={approach2GoCode} id="last-stone-weight-approach2-go" />
  </TabItem>
</Tabs>
