...
import practiceCodeSwift from './355-design-twitter.swift?raw';
...
import approach1SwiftCode from './355-design-twitter-approach1.swift?raw';
import approach2SwiftCode from './355-design-twitter-approach2.swift?raw';
import approach3SwiftCode from './355-design-twitter-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="355-design-twitter-swift" />
  </TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach1SwiftCode} id="355-design-twitter-approach1-swift" />
</TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach2SwiftCode} id="355-design-twitter-approach2-swift" />
</TabItem>
</Tabs>
...
<Tabs>
<TabItem label="Swift">
  <SwiftRepl code={approach3SwiftCode} id="355-design-twitter-approach3-swift" />
</TabItem>
</Tabs>
