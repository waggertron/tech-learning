...
final class Twitter {
    ...
    func getNewsFeed(_ userId: Int) -> [Int] { fatalError("TODO: Implement") }
    func follow(_ followerId: Int, _ followeeId: Int) { fatalError("TODO: Implement") }
    func unfollow(_ followerId: Int, _ followeeId: Int) { fatalError("TODO: Implement") }
}
