...
import practiceCodeSwift from './621-task-scheduler.swift?raw';
...
import approach1SwiftCode from './621-task-scheduler-approach1.swift?raw';
import approach2SwiftCode from './621-task-scheduler-approach2.swift?raw';
import approach3SwiftCode from './621-task-scheduler-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="621-task-scheduler-swift" />
  </TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach1SwiftCode} id="621-task-scheduler-approach1-swift" />
</TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach2SwiftCode} id="621-task-scheduler-approach2-swift" />
</TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach3SwiftCode} id="621-task-scheduler-approach3-swift" />
</TabItem>
</Tabs>
