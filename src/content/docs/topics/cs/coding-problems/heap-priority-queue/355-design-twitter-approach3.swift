...
final class Twitter {
    ...
    init() {}
    func postTweet(_ userId: Int, _ tweetId: Int) { clock += 1; tweets[userId, default: []].append(TweetRecord(time: clock, id: tweetId)); if tweets[userId]!.count > 10 { tweets[userId]!.removeFirst() } }
