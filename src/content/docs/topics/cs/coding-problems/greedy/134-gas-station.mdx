...
import practiceCodeSwift from './134-gas-station.swift?raw';
import approach1SwiftCode from './134-gas-station-approach1.swift?raw';
import approach2SwiftCode from './134-gas-station-approach2.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="134-gas-station-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="134-gas-station-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="134-gas-station-approach2-swift" />
  </TabItem>
</Tabs>
