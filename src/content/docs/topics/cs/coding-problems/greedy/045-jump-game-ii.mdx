...
import practiceCodeSwift from './045-jump-game-ii.swift?raw';
import approach1SwiftCode from './045-jump-game-ii-approach1.swift?raw';
import approach2SwiftCode from './045-jump-game-ii-approach2.swift?raw';
import approach3SwiftCode from './045-jump-game-ii-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="045-jump-game-ii-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="045-jump-game-ii-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="045-jump-game-ii-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="045-jump-game-ii-approach3-swift" />
  </TabItem>
</Tabs>
