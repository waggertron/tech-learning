...
import practiceCodeSwift from './055-jump-game.swift?raw';
import approach1SwiftCode from './055-jump-game-approach1.swift?raw';
import approach2SwiftCode from './055-jump-game-approach2.swift?raw';
import approach3SwiftCode from './055-jump-game-approach3.swift?raw';
import approach4SwiftCode from './055-jump-game-approach4.swift?raw';
import approach5SwiftCode from './055-jump-game-approach5.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="055-jump-game-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="055-jump-game-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="055-jump-game-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="055-jump-game-approach3-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach4SwiftCode} id="055-jump-game-approach4-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach5SwiftCode} id="055-jump-game-approach5-swift" />
  </TabItem>
</Tabs>
