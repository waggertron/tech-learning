...
import practiceCodeSwift from './334-increasing-triplet-subsequence.swift?raw';
import approach1SwiftCode from './334-increasing-triplet-subsequence-approach1.swift?raw';
import approach2SwiftCode from './334-increasing-triplet-subsequence-approach2.swift?raw';
import approach3SwiftCode from './334-increasing-triplet-subsequence-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="334-increasing-triplet-subsequence-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="334-increasing-triplet-subsequence-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="334-increasing-triplet-subsequence-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="334-increasing-triplet-subsequence-approach3-swift" />
  </TabItem>
</Tabs>
