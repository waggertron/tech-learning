...
import practiceCodeSwift from './678-valid-parenthesis-string.swift?raw';
import approach1SwiftCode from './678-valid-parenthesis-string-approach1.swift?raw';
import approach2SwiftCode from './678-valid-parenthesis-string-approach2.swift?raw';
import approach3SwiftCode from './678-valid-parenthesis-string-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="678-valid-parenthesis-string-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="678-valid-parenthesis-string-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="678-valid-parenthesis-string-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="678-valid-parenthesis-string-approach3-swift" />
  </TabItem>
</Tabs>
