...
import practiceCodeSwift from './122-best-time-to-buy-and-sell-stock-ii.swift?raw';
import approach1SwiftCode from './122-best-time-to-buy-and-sell-stock-ii-approach1.swift?raw';
import approach2SwiftCode from './122-best-time-to-buy-and-sell-stock-ii-approach2.swift?raw';
import approach3SwiftCode from './122-best-time-to-buy-and-sell-stock-ii-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="122-best-time-to-buy-and-sell-stock-ii-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="122-best-time-to-buy-and-sell-stock-ii-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="122-best-time-to-buy-and-sell-stock-ii-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="122-best-time-to-buy-and-sell-stock-ii-approach3-swift" />
  </TabItem>
</Tabs>
