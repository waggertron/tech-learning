...
import practiceCodeSwift from './004-median-of-two-sorted-arrays.swift?raw';
import approach1SwiftCode from './004-median-of-two-sorted-arrays-approach1.swift?raw';
import approach2SwiftCode from './004-median-of-two-sorted-arrays-approach2.swift?raw';
import approach3SwiftCode from './004-median-of-two-sorted-arrays-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="004-median-of-two-sorted-arrays-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="004-median-of-two-sorted-arrays-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="004-median-of-two-sorted-arrays-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="004-median-of-two-sorted-arrays-approach3-swift" />
  </TabItem>
</Tabs>
