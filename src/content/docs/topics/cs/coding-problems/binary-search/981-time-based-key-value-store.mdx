...
import practiceCodeSwift from './981-time-based-key-value-store.swift?raw';
import approach1SwiftCode from './981-time-based-key-value-store-approach1.swift?raw';
import approach2SwiftCode from './981-time-based-key-value-store-approach2.swift?raw';
import approach3SwiftCode from './981-time-based-key-value-store-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="981-time-based-key-value-store-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="981-time-based-key-value-store-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="981-time-based-key-value-store-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="981-time-based-key-value-store-approach3-swift" />
  </TabItem>
</Tabs>
