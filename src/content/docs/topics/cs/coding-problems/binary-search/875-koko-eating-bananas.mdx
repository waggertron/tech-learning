...
import practiceCodeSwift from './875-koko-eating-bananas.swift?raw';
import approach1SwiftCode from './875-koko-eating-bananas-approach1.swift?raw';
import approach2SwiftCode from './875-koko-eating-bananas-approach2.swift?raw';
import approach3SwiftCode from './875-koko-eating-bananas-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="875-koko-eating-bananas-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="875-koko-eating-bananas-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="875-koko-eating-bananas-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="875-koko-eating-bananas-approach3-swift" />
  </TabItem>
</Tabs>
