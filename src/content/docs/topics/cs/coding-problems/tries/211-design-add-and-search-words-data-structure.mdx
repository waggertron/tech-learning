...
import practiceCodeSwift from './211-design-add-and-search-words-data-structure.swift?raw';
import approach1SwiftCode from './211-design-add-and-search-words-data-structure-approach1.swift?raw';
import approach2SwiftCode from './211-design-add-and-search-words-data-structure-approach2.swift?raw';
import approach3SwiftCode from './211-design-add-and-search-words-data-structure-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="211-design-add-and-search-words-data-structure-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="211-design-add-and-search-words-data-structure-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="211-design-add-and-search-words-data-structure-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="211-design-add-and-search-words-data-structure-approach3-swift" />
  </TabItem>
</Tabs>
