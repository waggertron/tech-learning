...
final class Trie {
    ...
    init() {}
    func insert(_ word: String) { words.insert(word) }
    func search(_ word: String) -> Bool { words.contains(word) }
    func startsWith(_ prefix: String) -> Bool { words.contains { $0.hasPrefix(prefix) } }
}
