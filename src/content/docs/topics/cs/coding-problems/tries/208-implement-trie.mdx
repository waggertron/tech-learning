...
import practiceCodeSwift from './208-implement-trie.swift?raw';
import approach1SwiftCode from './208-implement-trie-approach1.swift?raw';
import approach2SwiftCode from './208-implement-trie-approach2.swift?raw';
import approach3SwiftCode from './208-implement-trie-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="208-implement-trie-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="208-implement-trie-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="208-implement-trie-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="208-implement-trie-approach3-swift" />
  </TabItem>
</Tabs>
