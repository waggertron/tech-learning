...
import practiceCodeSwift from './994-rotting-oranges.swift?raw';
import approach1SwiftCode from './994-rotting-oranges-approach1.swift?raw';
import approach2SwiftCode from './994-rotting-oranges-approach2.swift?raw';
import approach3SwiftCode from './994-rotting-oranges-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="994-rotting-oranges-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="994-rotting-oranges-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="994-rotting-oranges-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="994-rotting-oranges-approach3-swift" />
  </TabItem>
</Tabs>
