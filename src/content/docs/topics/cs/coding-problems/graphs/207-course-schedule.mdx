...
import practiceCodeSwift from './207-course-schedule.swift?raw';
import approach1SwiftCode from './207-course-schedule-approach1.swift?raw';
import approach2SwiftCode from './207-course-schedule-approach2.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="207-course-schedule-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="207-course-schedule-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="207-course-schedule-approach2-swift" />
  </TabItem>
</Tabs>
...
- [Topological Sort](../../../coding-concepts/topological-sort/), dependency-order tactics for DAGs, prerequisites, and detecting cycles in directed graphs.
