...
import practiceCodeSwift from './269-alien-dictionary.swift?raw';
import approach1SwiftCode from './269-alien-dictionary-approach1.swift?raw';
import approach2SwiftCode from './269-alien-dictionary-approach2.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="269-alien-dictionary-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="269-alien-dictionary-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="269-alien-dictionary-approach2-swift" />
  </TabItem>
</Tabs>
