...
import practiceCodeSwift from './210-course-schedule-ii.swift?raw';
import approach1SwiftCode from './210-course-schedule-ii-approach1.swift?raw';
import approach2SwiftCode from './210-course-schedule-ii-approach2.swift?raw';
import approach3SwiftCode from './210-course-schedule-ii-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="210-course-schedule-ii-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="210-course-schedule-ii-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="210-course-schedule-ii-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="210-course-schedule-ii-approach3-swift" />
  </TabItem>
</Tabs>
