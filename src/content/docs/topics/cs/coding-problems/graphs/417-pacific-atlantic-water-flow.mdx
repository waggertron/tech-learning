...
import practiceCodeSwift from './417-pacific-atlantic-water-flow.swift?raw';
import approach1SwiftCode from './417-pacific-atlantic-water-flow-approach1.swift?raw';
import approach2SwiftCode from './417-pacific-atlantic-water-flow-approach2.swift?raw';
import approach3SwiftCode from './417-pacific-atlantic-water-flow-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="417-pacific-atlantic-water-flow-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="417-pacific-atlantic-water-flow-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="417-pacific-atlantic-water-flow-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="417-pacific-atlantic-water-flow-approach3-swift" />
  </TabItem>
</Tabs>
