...
import practiceCodeSwift from './684-redundant-connection.swift?raw';
import approach1SwiftCode from './684-redundant-connection-approach1.swift?raw';
import approach2SwiftCode from './684-redundant-connection-approach2.swift?raw';
import approach3SwiftCode from './684-redundant-connection-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="684-redundant-connection-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="684-redundant-connection-approach1-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="684-redundant-connection-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="684-redundant-connection-approach3-swift" />
  </TabItem>
</Tabs>
