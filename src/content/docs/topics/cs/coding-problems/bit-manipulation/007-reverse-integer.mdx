...
import practiceCodeSwift from './007-reverse-integer.swift?raw';
import approach1SwiftCode from './007-reverse-integer-approach1.swift?raw';
import approach2SwiftCode from './007-reverse-integer-approach2.swift?raw';
import approach3SwiftCode from './007-reverse-integer-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="007-reverse-integer-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="007-reverse-integer-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="007-reverse-integer-approach2-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="007-reverse-integer-approach3-swift" />
  </TabItem>
</Tabs>
