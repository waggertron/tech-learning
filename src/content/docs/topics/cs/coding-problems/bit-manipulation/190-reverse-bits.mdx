...
import practiceCodeSwift from './190-reverse-bits.swift?raw';
import approach1SwiftCode from './190-reverse-bits-approach1.swift?raw';
import approach2SwiftCode from './190-reverse-bits-approach2.swift?raw';
import approach3SwiftCode from './190-reverse-bits-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="190-reverse-bits-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="190-reverse-bits-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="190-reverse-bits-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="190-reverse-bits-approach3-swift" />
  </TabItem>
</Tabs>
