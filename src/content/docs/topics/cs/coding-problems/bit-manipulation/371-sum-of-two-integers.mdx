...
import practiceCodeSwift from './371-sum-of-two-integers.swift?raw';
import approach1SwiftCode from './371-sum-of-two-integers-approach1.swift?raw';
import approach2SwiftCode from './371-sum-of-two-integers-approach2.swift?raw';
import approach3SwiftCode from './371-sum-of-two-integers-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="371-sum-of-two-integers-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="371-sum-of-two-integers-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="371-sum-of-two-integers-approach2-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="371-sum-of-two-integers-approach3-swift" />
  </TabItem>
</Tabs>
