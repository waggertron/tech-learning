...
**Bonus problems (same patterns, outside NeetCode 150):**

8. [394. Decode String (Medium)](./394-decode-string/)
9. [735. Asteroid Collision (Medium)](./735-asteroid-collision/)
...
- **Nested structure decoding**: Decode String (stack of count + prefix pairs).
- **Collision simulation**: Asteroid Collision (stack of survivors).
