...
import practiceCodeSwift from './084-largest-rectangle-in-histogram.swift?raw';
import approach1SwiftCode from './084-largest-rectangle-in-histogram-approach1.swift?raw';
import approach2SwiftCode from './084-largest-rectangle-in-histogram-approach2.swift?raw';
import approach3SwiftCode from './084-largest-rectangle-in-histogram-approach3.swift?raw';
import approach2PyCode from './084-largest-rectangle-in-histogram-approach2.py?raw';
...
import approach3PyCode from './084-largest-rectangle-in-histogram-approach3.py?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="084-largest-rectangle-in-histogram-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="084-largest-rectangle-in-histogram-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="084-largest-rectangle-in-histogram-approach2-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Python">
    <PythonRepl code={approach2PyCode} id="largest-rectangle-approach2-py" />
  </TabItem>
  <TabItem label="TypeScript">
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="084-largest-rectangle-in-histogram-approach3-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Python">
    <PythonRepl code={approach3PyCode} id="largest-rectangle-approach3-py" />
  </TabItem>
  <TabItem label="TypeScript">
