...
import practiceCodeGo from './735-asteroid-collision.go?raw';
import practiceCodeSwift from './735-asteroid-collision.swift?raw';
import approach1SwiftCode from './735-asteroid-collision-approach1.swift?raw';
import approach2PyCode from './735-asteroid-collision-approach2.py?raw';
import approach2TsCode from './735-asteroid-collision-approach2.ts?raw';
import approach2GoCode from './735-asteroid-collision-approach2.go?raw';
...
<Tabs>
  ...
  <TabItem label="Go">
    <GoRepl code={practiceCodeGo} id="asteroid-collision-go" />
  </TabItem>
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="735-asteroid-collision-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="735-asteroid-collision-approach1-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Python">
    <PythonRepl code={approach2PyCode} id="asteroid-collision-approach2-py" />
  </TabItem>
  <TabItem label="TypeScript">
    <TypeScriptRepl code={approach2TsCode} id="asteroid-collision-approach2-ts" />
  </TabItem>
  <TabItem label="Go">
    <GoRepl code={approach2GoCode} id="asteroid-collision-approach2-go" />
  </TabItem>
