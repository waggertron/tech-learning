...
import practiceCodeSwift from './022-generate-parentheses.swift?raw';
import approach1SwiftCode from './022-generate-parentheses-approach1.swift?raw';
import approach2SwiftCode from './022-generate-parentheses-approach2.swift?raw';
import approach3SwiftCode from './022-generate-parentheses-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="022-generate-parentheses-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="022-generate-parentheses-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="022-generate-parentheses-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="022-generate-parentheses-approach3-swift" />
  </TabItem>
</Tabs>
