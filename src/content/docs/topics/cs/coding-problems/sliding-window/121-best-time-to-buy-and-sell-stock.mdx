...
import practiceCodeSwift from './121-best-time-to-buy-and-sell-stock.swift?raw';
import approach1SwiftCode from './121-best-time-to-buy-and-sell-stock-approach1.swift?raw';
import approach2SwiftCode from './121-best-time-to-buy-and-sell-stock-approach2.swift?raw';
import approach3SwiftCode from './121-best-time-to-buy-and-sell-stock-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="121-best-time-to-buy-and-sell-stock-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="121-best-time-to-buy-and-sell-stock-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="121-best-time-to-buy-and-sell-stock-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="121-best-time-to-buy-and-sell-stock-approach3-swift" />
  </TabItem>
</Tabs>
