...
import practiceCodeSwift from './003-longest-substring-without-repeating-characters.swift?raw';
import approach1SwiftCode from './003-longest-substring-without-repeating-characters-approach1.swift?raw';
import approach2SwiftCode from './003-longest-substring-without-repeating-characters-approach2.swift?raw';
import approach3SwiftCode from './003-longest-substring-without-repeating-characters-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="003-longest-substring-without-repeating-characters-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="003-longest-substring-without-repeating-characters-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="003-longest-substring-without-repeating-characters-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="003-longest-substring-without-repeating-characters-approach3-swift" />
  </TabItem>
</Tabs>
