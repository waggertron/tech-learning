...
import practiceCodeSwift from './076-minimum-window-substring.swift?raw';
import approach1SwiftCode from './076-minimum-window-substring-approach1.swift?raw';
import approach2SwiftCode from './076-minimum-window-substring-approach2.swift?raw';
import approach3SwiftCode from './076-minimum-window-substring-approach3.swift?raw';
import approach3PyCode from './076-minimum-window-substring-approach3.py?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="076-minimum-window-substring-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="076-minimum-window-substring-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="076-minimum-window-substring-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="076-minimum-window-substring-approach3-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="Python">
    <PythonRepl code={approach3PyCode} id="minimum-window-approach3-py" />
  </TabItem>
  <TabItem label="TypeScript">
