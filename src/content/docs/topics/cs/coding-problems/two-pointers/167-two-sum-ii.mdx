...
import practiceCodeSwift from './167-two-sum-ii.swift?raw';
import approach1SwiftCode from './167-two-sum-ii-approach1.swift?raw';
import approach2SwiftCode from './167-two-sum-ii-approach2.swift?raw';
import approach3SwiftCode from './167-two-sum-ii-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="167-two-sum-ii-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="167-two-sum-ii-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="167-two-sum-ii-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="167-two-sum-ii-approach3-swift" />
  </TabItem>
</Tabs>
