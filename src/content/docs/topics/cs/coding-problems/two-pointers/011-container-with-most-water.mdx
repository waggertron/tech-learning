...
import practiceCodeSwift from './011-container-with-most-water.swift?raw';
import approach1SwiftCode from './011-container-with-most-water-approach1.swift?raw';
import approach2SwiftCode from './011-container-with-most-water-approach2.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="011-container-with-most-water-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="011-container-with-most-water-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="011-container-with-most-water-approach2-swift" />
  </TabItem>
</Tabs>
