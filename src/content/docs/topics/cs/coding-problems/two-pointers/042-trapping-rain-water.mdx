...
import practiceCodeSwift from './042-trapping-rain-water.swift?raw';
import approach1SwiftCode from './042-trapping-rain-water-approach1.swift?raw';
import approach2SwiftCode from './042-trapping-rain-water-approach2.swift?raw';
import approach3SwiftCode from './042-trapping-rain-water-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="042-trapping-rain-water-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="042-trapping-rain-water-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="042-trapping-rain-water-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="042-trapping-rain-water-approach3-swift" />
  </TabItem>
</Tabs>
