...
import practiceCodeSwift from './125-valid-palindrome.swift?raw';
import approach1SwiftCode from './125-valid-palindrome-approach1.swift?raw';
import approach2SwiftCode from './125-valid-palindrome-approach2.swift?raw';
import approach3SwiftCode from './125-valid-palindrome-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="125-valid-palindrome-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="125-valid-palindrome-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="125-valid-palindrome-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="125-valid-palindrome-approach3-swift" />
  </TabItem>
</Tabs>
