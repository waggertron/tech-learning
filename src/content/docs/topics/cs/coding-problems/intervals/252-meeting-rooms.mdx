...
import practiceCodeSwift from './252-meeting-rooms.swift?raw';
import approach1SwiftCode from './252-meeting-rooms-approach1.swift?raw';
import approach2SwiftCode from './252-meeting-rooms-approach2.swift?raw';
import approach3SwiftCode from './252-meeting-rooms-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="252-meeting-rooms-swift" />
  </TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach1SwiftCode} id="252-meeting-rooms-approach1-swift" />
</TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach2SwiftCode} id="252-meeting-rooms-approach2-swift" />
</TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach3SwiftCode} id="252-meeting-rooms-approach3-swift" />
</TabItem>
</Tabs>
