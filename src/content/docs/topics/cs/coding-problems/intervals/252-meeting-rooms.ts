...
function _runTests(): void {
    ...
    canAttendMeetings(Array.from({ length: 1000 }, (_, i) => [2 * i, 2 * i + 1]));
    console.log(`perf canAttendMeetings 1000 non-overlapping intervals: ${(performance.now() - t0).toFixed(1)}ms`);
