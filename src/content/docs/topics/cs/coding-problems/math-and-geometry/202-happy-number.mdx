...
import practiceCodeSwift from './202-happy-number.swift?raw';
import approach1SwiftCode from './202-happy-number-approach1.swift?raw';
import approach2SwiftCode from './202-happy-number-approach2.swift?raw';
import approach3SwiftCode from './202-happy-number-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="202-happy-number-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="202-happy-number-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="202-happy-number-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="202-happy-number-approach3-swift" />
  </TabItem>
</Tabs>
