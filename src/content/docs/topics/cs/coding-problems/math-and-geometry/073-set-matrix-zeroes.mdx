...
import practiceCodeSwift from './073-set-matrix-zeroes.swift?raw';
import approach1SwiftCode from './073-set-matrix-zeroes-approach1.swift?raw';
import approach2SwiftCode from './073-set-matrix-zeroes-approach2.swift?raw';
import approach3SwiftCode from './073-set-matrix-zeroes-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="073-set-matrix-zeroes-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="073-set-matrix-zeroes-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="073-set-matrix-zeroes-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="073-set-matrix-zeroes-approach3-swift" />
  </TabItem>
</Tabs>
