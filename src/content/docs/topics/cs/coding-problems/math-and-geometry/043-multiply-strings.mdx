...
import practiceCodeSwift from './043-multiply-strings.swift?raw';
import approach1SwiftCode from './043-multiply-strings-approach1.swift?raw';
import approach2SwiftCode from './043-multiply-strings-approach2.swift?raw';
import approach3SwiftCode from './043-multiply-strings-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="043-multiply-strings-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="043-multiply-strings-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="043-multiply-strings-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="043-multiply-strings-approach3-swift" />
  </TabItem>
</Tabs>
