...
import practiceCodeSwift from './048-rotate-image.swift?raw';
import approach1SwiftCode from './048-rotate-image-approach1.swift?raw';
import approach2SwiftCode from './048-rotate-image-approach2.swift?raw';
import approach3SwiftCode from './048-rotate-image-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="048-rotate-image-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="048-rotate-image-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="048-rotate-image-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="048-rotate-image-approach3-swift" />
  </TabItem>
</Tabs>
