...
import practiceCodeSwift from './066-plus-one.swift?raw';
import approach1SwiftCode from './066-plus-one-approach1.swift?raw';
import approach2SwiftCode from './066-plus-one-approach2.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="066-plus-one-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="066-plus-one-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="066-plus-one-approach2-swift" />
  </TabItem>
</Tabs>
