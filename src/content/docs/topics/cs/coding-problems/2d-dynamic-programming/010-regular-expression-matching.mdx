...
import practiceCodeSwift from './010-regular-expression-matching.swift?raw';
import approach1SwiftCode from './010-regular-expression-matching-approach1.swift?raw';
import approach2SwiftCode from './010-regular-expression-matching-approach2.swift?raw';
import approach3SwiftCode from './010-regular-expression-matching-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="010-regular-expression-matching-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="010-regular-expression-matching-approach1-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="010-regular-expression-matching-approach2-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="010-regular-expression-matching-approach3-swift" />
  </TabItem>
</Tabs>
