...
import practiceCodeSwift from './494-target-sum.swift?raw';
import approach1SwiftCode from './494-target-sum-approach1.swift?raw';
import approach2SwiftCode from './494-target-sum-approach2.swift?raw';
import approach3SwiftCode from './494-target-sum-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="494-target-sum-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="494-target-sum-approach1-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="494-target-sum-approach2-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="494-target-sum-approach3-swift" />
  </TabItem>
</Tabs>
