...
import practiceCodeSwift from './714-best-time-to-buy-and-sell-stock-with-transaction-fee.swift?raw';
import approach1SwiftCode from './714-best-time-to-buy-and-sell-stock-with-transaction-fee-approach1.swift?raw';
import approach2SwiftCode from './714-best-time-to-buy-and-sell-stock-with-transaction-fee-approach2.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="714-best-time-to-buy-and-sell-stock-with-transaction-fee-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="714-best-time-to-buy-and-sell-stock-with-transaction-fee-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="714-best-time-to-buy-and-sell-stock-with-transaction-fee-approach2-swift" />
  </TabItem>
</Tabs>
