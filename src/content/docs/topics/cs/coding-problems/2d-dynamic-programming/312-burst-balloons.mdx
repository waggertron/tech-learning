...
import practiceCodeSwift from './312-burst-balloons.swift?raw';
import approach1SwiftCode from './312-burst-balloons-approach1.swift?raw';
import approach2SwiftCode from './312-burst-balloons-approach2.swift?raw';
import approach3SwiftCode from './312-burst-balloons-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="312-burst-balloons-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="312-burst-balloons-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="312-burst-balloons-approach2-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="312-burst-balloons-approach3-swift" />
  </TabItem>
</Tabs>
