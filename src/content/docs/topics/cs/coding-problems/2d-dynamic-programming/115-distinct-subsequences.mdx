...
import practiceCodeSwift from './115-distinct-subsequences.swift?raw';
import approach1SwiftCode from './115-distinct-subsequences-approach1.swift?raw';
import approach2SwiftCode from './115-distinct-subsequences-approach2.swift?raw';
import approach3SwiftCode from './115-distinct-subsequences-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="115-distinct-subsequences-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="115-distinct-subsequences-approach1-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="115-distinct-subsequences-approach2-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="115-distinct-subsequences-approach3-swift" />
  </TabItem>
</Tabs>
