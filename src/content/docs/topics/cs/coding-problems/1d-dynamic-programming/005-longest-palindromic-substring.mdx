...
import practiceCodeSwift from './005-longest-palindromic-substring.swift?raw';
import approach1SwiftCode from './005-longest-palindromic-substring-approach1.swift?raw';
import approach2SwiftCode from './005-longest-palindromic-substring-approach2.swift?raw';
import approach3SwiftCode from './005-longest-palindromic-substring-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="005-longest-palindromic-substring-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="005-longest-palindromic-substring-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="005-longest-palindromic-substring-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="005-longest-palindromic-substring-approach3-swift" />
  </TabItem>
</Tabs>
