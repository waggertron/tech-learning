...
final class Solution {
    func countSubstrings(_ s: String) -> Int { let c = Array(s); var count = 0; for i in c.indices { for j in i..<c.count { let part = Array(c[i...j]); if part == Array(part.reversed()) { count += 1 } } }; return count }
}
