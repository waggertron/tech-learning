...
import practiceCodeSwift from './152-maximum-product-subarray.swift?raw';
import approach1SwiftCode from './152-maximum-product-subarray-approach1.swift?raw';
import approach2SwiftCode from './152-maximum-product-subarray-approach2.swift?raw';
import approach3SwiftCode from './152-maximum-product-subarray-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="152-maximum-product-subarray-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="152-maximum-product-subarray-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="152-maximum-product-subarray-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="152-maximum-product-subarray-approach3-swift" />
  </TabItem>
</Tabs>
