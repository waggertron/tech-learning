...
import practiceCodeSwift from './647-palindromic-substrings.swift?raw';
import approach1SwiftCode from './647-palindromic-substrings-approach1.swift?raw';
import approach2SwiftCode from './647-palindromic-substrings-approach2.swift?raw';
import approach3SwiftCode from './647-palindromic-substrings-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="647-palindromic-substrings-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="647-palindromic-substrings-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="647-palindromic-substrings-approach2-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Go">
    <GoRepl code={approach2GoCode} id="palindromic-substrings-approach2-go" />
  </TabItem>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="647-palindromic-substrings-approach3-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Go">
    <GoRepl code={approach3GoCode} id="palindromic-substrings-approach3-go" />
  </TabItem>
