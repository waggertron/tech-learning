...
import practiceCodeSwift from './100-same-tree.swift?raw';
import approach1SwiftCode from './100-same-tree-approach1.swift?raw';
import approach2SwiftCode from './100-same-tree-approach2.swift?raw';
import approach3SwiftCode from './100-same-tree-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="100-same-tree-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="100-same-tree-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="100-same-tree-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="100-same-tree-approach3-swift" />
  </TabItem>
</Tabs>
