...
final class Codec {
    func serialize(_ root: TreeNode?) -> String { fatalError("TODO: Implement") }
    func deserialize(_ data: String) -> TreeNode? { fatalError("TODO: Implement") }
    func roundTrip(_ root: TreeNode?) -> TreeNode? {
        // TODO: Implement
