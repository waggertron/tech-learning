...
import practiceCodeSwift from './226-invert-binary-tree.swift?raw';
import approach1SwiftCode from './226-invert-binary-tree-approach1.swift?raw';
import approach2SwiftCode from './226-invert-binary-tree-approach2.swift?raw';
import approach3SwiftCode from './226-invert-binary-tree-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="226-invert-binary-tree-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="226-invert-binary-tree-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="226-invert-binary-tree-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="226-invert-binary-tree-approach3-swift" />
  </TabItem>
</Tabs>
