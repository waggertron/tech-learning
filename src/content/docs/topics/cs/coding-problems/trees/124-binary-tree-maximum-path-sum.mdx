...
import practiceCodeSwift from './124-binary-tree-maximum-path-sum.swift?raw';
import approach1SwiftCode from './124-binary-tree-maximum-path-sum-approach1.swift?raw';
import approach2SwiftCode from './124-binary-tree-maximum-path-sum-approach2.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="124-binary-tree-maximum-path-sum-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="124-binary-tree-maximum-path-sum-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="124-binary-tree-maximum-path-sum-approach2-swift" />
  </TabItem>
</Tabs>
