...
import practiceCodeTs from './1448-count-good-nodes-in-binary-tree.ts?raw';
import practiceCodeGo from './1448-count-good-nodes-in-binary-tree.go?raw';
import practiceCodeSwift from './1448-count-good-nodes-in-binary-tree.swift?raw';
import approach1SwiftCode from './1448-count-good-nodes-in-binary-tree-approach1.swift?raw';
import approach2SwiftCode from './1448-count-good-nodes-in-binary-tree-approach2.swift?raw';
import approach3SwiftCode from './1448-count-good-nodes-in-binary-tree-approach3.swift?raw';
import approach2PyCode from './1448-count-good-nodes-in-binary-tree-approach2.py?raw';
import approach2TsCode from './1448-count-good-nodes-in-binary-tree-approach2.ts?raw';
import approach2GoCode from './1448-count-good-nodes-in-binary-tree-approach2.go?raw';
...
<Tabs>
  <TabItem label="Python">
    <PythonRepl code={practiceCode} id="count-good-nodes-in-binary-tree-py" />
  </TabItem>
  <TabItem label="TypeScript">
    <TypeScriptRepl code={practiceCodeTs} id="count-good-nodes-in-binary-tree-ts" />
  </TabItem>
  <TabItem label="Go">
    <GoRepl code={practiceCodeGo} id="count-good-nodes-in-binary-tree-go" />
  </TabItem>
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="1448-count-good-nodes-in-binary-tree-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="1448-count-good-nodes-in-binary-tree-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="1448-count-good-nodes-in-binary-tree-approach2-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="Python">
    <PythonRepl code={approach2PyCode} id="count-good-nodes-approach2-py" />
  </TabItem>
  <TabItem label="TypeScript">
    <TypeScriptRepl code={approach2TsCode} id="count-good-nodes-approach2-ts" />
  </TabItem>
  <TabItem label="Go">
    <GoRepl code={approach2GoCode} id="count-good-nodes-approach2-go" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="1448-count-good-nodes-in-binary-tree-approach3-swift" />
  </TabItem>
</Tabs>
...
console.assert(goodNodes(buildTree([3, 1, 4, 3, null, 1, 5])) === 4);
console.assert(goodNodes(buildTree([3, 3, null, 4, 2])) === 3);
console.assert(goodNodes(buildTree([1])) === 1);
console.assert(goodNodes(buildTree([5, 4, 6, 3, null, null, 7])) === 3);
