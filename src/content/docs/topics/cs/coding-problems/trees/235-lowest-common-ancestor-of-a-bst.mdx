...
import practiceCodeSwift from './235-lowest-common-ancestor-of-a-bst.swift?raw';
import approach1SwiftCode from './235-lowest-common-ancestor-of-a-bst-approach1.swift?raw';
import approach2SwiftCode from './235-lowest-common-ancestor-of-a-bst-approach2.swift?raw';
import approach3SwiftCode from './235-lowest-common-ancestor-of-a-bst-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="235-lowest-common-ancestor-of-a-bst-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="235-lowest-common-ancestor-of-a-bst-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="235-lowest-common-ancestor-of-a-bst-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="235-lowest-common-ancestor-of-a-bst-approach3-swift" />
  </TabItem>
</Tabs>
