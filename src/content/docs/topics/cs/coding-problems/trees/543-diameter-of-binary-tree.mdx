...
import practiceCodeSwift from './543-diameter-of-binary-tree.swift?raw';
import approach1SwiftCode from './543-diameter-of-binary-tree-approach1.swift?raw';
import approach2SwiftCode from './543-diameter-of-binary-tree-approach2.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="543-diameter-of-binary-tree-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="543-diameter-of-binary-tree-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="543-diameter-of-binary-tree-approach2-swift" />
  </TabItem>
</Tabs>
