...
import practiceCodeSwift from './098-validate-binary-search-tree.swift?raw';
import approach1SwiftCode from './098-validate-binary-search-tree-approach1.swift?raw';
import approach2SwiftCode from './098-validate-binary-search-tree-approach2.swift?raw';
import approach3SwiftCode from './098-validate-binary-search-tree-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="098-validate-binary-search-tree-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="098-validate-binary-search-tree-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="098-validate-binary-search-tree-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="098-validate-binary-search-tree-approach3-swift" />
  </TabItem>
</Tabs>
