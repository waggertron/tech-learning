...
import practiceCodeSwift from './110-balanced-binary-tree.swift?raw';
import approach1SwiftCode from './110-balanced-binary-tree-approach1.swift?raw';
import approach2SwiftCode from './110-balanced-binary-tree-approach2.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="110-balanced-binary-tree-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="110-balanced-binary-tree-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="110-balanced-binary-tree-approach2-swift" />
  </TabItem>
</Tabs>
