...
import practiceCodeSwift from './297-serialize-and-deserialize-binary-tree.swift?raw';
import approach1SwiftCode from './297-serialize-and-deserialize-binary-tree-approach1.swift?raw';
import approach2SwiftCode from './297-serialize-and-deserialize-binary-tree-approach2.swift?raw';
import approach3SwiftCode from './297-serialize-and-deserialize-binary-tree-approach3.swift?raw';
...
import approach2GoCode from './297-serialize-and-deserialize-binary-tree-approach2.go?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="297-serialize-and-deserialize-binary-tree-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="297-serialize-and-deserialize-binary-tree-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="297-serialize-and-deserialize-binary-tree-approach2-swift" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Go">
    <GoRepl code={approach2GoCode} id="serialize-and-deserialize-approach2-go" />
  </TabItem>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="297-serialize-and-deserialize-binary-tree-approach3-swift" />
  </TabItem>
</Tabs>
