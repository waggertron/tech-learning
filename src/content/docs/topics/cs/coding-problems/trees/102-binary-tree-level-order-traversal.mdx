...
import practiceCodeSwift from './102-binary-tree-level-order-traversal.swift?raw';
import approach1SwiftCode from './102-binary-tree-level-order-traversal-approach1.swift?raw';
import approach2SwiftCode from './102-binary-tree-level-order-traversal-approach2.swift?raw';
import approach3SwiftCode from './102-binary-tree-level-order-traversal-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="102-binary-tree-level-order-traversal-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach1SwiftCode} id="102-binary-tree-level-order-traversal-approach1-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach2SwiftCode} id="102-binary-tree-level-order-traversal-approach2-swift" />
  </TabItem>
</Tabs>
...
```
  ...
  <TabItem label="Swift">
    <SwiftRepl code={approach3SwiftCode} id="102-binary-tree-level-order-traversal-approach3-swift" />
  </TabItem>
</Tabs>
...
- [Tree Traversal](../../../coding-concepts/tree-traversal/), recursive and iterative tactics for visiting tree nodes with path, depth, or structural state.
