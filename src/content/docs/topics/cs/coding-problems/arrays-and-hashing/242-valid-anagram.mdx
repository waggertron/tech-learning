...
import practiceCodeSwift from './242-valid-anagram.swift?raw';
import approach1SwiftCode from './242-valid-anagram-approach1.swift?raw';
import approach2SwiftCode from './242-valid-anagram-approach2.swift?raw';
import approach3SwiftCode from './242-valid-anagram-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="242-valid-anagram-swift" />
  </TabItem>
</Tabs>
...
<SwiftRepl code={approach1SwiftCode} id="242-valid-anagram-approach1-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach2SwiftCode} id="242-valid-anagram-approach2-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach3SwiftCode} id="242-valid-anagram-approach3-swift" />
</TabItem>
</Tabs>
