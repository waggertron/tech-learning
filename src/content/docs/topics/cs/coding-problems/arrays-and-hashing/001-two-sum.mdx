...
import practiceCodeSwift from './001-two-sum.swift?raw';
import approach1SwiftCode from './001-two-sum-approach1.swift?raw';
import approach2SwiftCode from './001-two-sum-approach2.swift?raw';
import approach3SwiftCode from './001-two-sum-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="001-two-sum-swift" />
  </TabItem>
</Tabs>
...
<SwiftRepl code={approach1SwiftCode} id="001-two-sum-approach1-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach2SwiftCode} id="001-two-sum-approach2-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach3SwiftCode} id="001-two-sum-approach3-swift" />
</TabItem>
</Tabs>
