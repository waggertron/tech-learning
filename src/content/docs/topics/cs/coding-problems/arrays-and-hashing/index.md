...
description: "15 problems covering hash maps, frequency counting, prefix sums, and the complement-lookup pattern that appears throughout every other category."
