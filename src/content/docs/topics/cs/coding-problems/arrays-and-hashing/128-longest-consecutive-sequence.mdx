...
import practiceCodeSwift from './128-longest-consecutive-sequence.swift?raw';
import approach1SwiftCode from './128-longest-consecutive-sequence-approach1.swift?raw';
import approach2SwiftCode from './128-longest-consecutive-sequence-approach2.swift?raw';
import approach3SwiftCode from './128-longest-consecutive-sequence-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="128-longest-consecutive-sequence-swift" />
  </TabItem>
</Tabs>
...
<SwiftRepl code={approach1SwiftCode} id="128-longest-consecutive-sequence-approach1-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach2SwiftCode} id="128-longest-consecutive-sequence-approach2-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach3SwiftCode} id="128-longest-consecutive-sequence-approach3-swift" />
</TabItem>
</Tabs>
