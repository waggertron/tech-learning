...
import practiceCodeSwift from './347-top-k-frequent-elements.swift?raw';
import approach1SwiftCode from './347-top-k-frequent-elements-approach1.swift?raw';
import approach2SwiftCode from './347-top-k-frequent-elements-approach2.swift?raw';
import approach3SwiftCode from './347-top-k-frequent-elements-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="347-top-k-frequent-elements-swift" />
  </TabItem>
</Tabs>
...
<SwiftRepl code={approach1SwiftCode} id="347-top-k-frequent-elements-approach1-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach2SwiftCode} id="347-top-k-frequent-elements-approach2-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach3SwiftCode} id="347-top-k-frequent-elements-approach3-swift" />
</TabItem>
</Tabs>
