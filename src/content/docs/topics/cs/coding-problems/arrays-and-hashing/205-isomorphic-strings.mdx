...
import practiceCodeSwift from './205-isomorphic-strings.swift?raw';
import approach1SwiftCode from './205-isomorphic-strings-approach1.swift?raw';
import approach2SwiftCode from './205-isomorphic-strings-approach2.swift?raw';
import approach3SwiftCode from './205-isomorphic-strings-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="205-isomorphic-strings-swift" />
  </TabItem>
</Tabs>
...
<SwiftRepl code={approach1SwiftCode} id="205-isomorphic-strings-approach1-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach2SwiftCode} id="205-isomorphic-strings-approach2-swift" />
</TabItem>
</Tabs>
...
<SwiftRepl code={approach3SwiftCode} id="205-isomorphic-strings-approach3-swift" />
</TabItem>
</Tabs>
