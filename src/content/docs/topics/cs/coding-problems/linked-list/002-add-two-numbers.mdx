...
import practiceCodeSwift from './002-add-two-numbers.swift?raw';
import approach1SwiftCode from './002-add-two-numbers-approach1.swift?raw';
import approach2SwiftCode from './002-add-two-numbers-approach2.swift?raw';
import approach3SwiftCode from './002-add-two-numbers-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="002-add-two-numbers-swift" />
  </TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach1SwiftCode} id="002-add-two-numbers-approach1-swift" />
</TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach2SwiftCode} id="002-add-two-numbers-approach2-swift" />
</TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach3SwiftCode} id="002-add-two-numbers-approach3-swift" />
</TabItem>
</Tabs>
