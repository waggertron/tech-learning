...
import practiceCodeSwift from './143-reorder-list.swift?raw';
import approach1SwiftCode from './143-reorder-list-approach1.swift?raw';
import approach2SwiftCode from './143-reorder-list-approach2.swift?raw';
import approach3SwiftCode from './143-reorder-list-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="143-reorder-list-swift" />
  </TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach1SwiftCode} id="143-reorder-list-approach1-swift" />
</TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach2SwiftCode} id="143-reorder-list-approach2-swift" />
</TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach3SwiftCode} id="143-reorder-list-approach3-swift" />
</TabItem>
</Tabs>
