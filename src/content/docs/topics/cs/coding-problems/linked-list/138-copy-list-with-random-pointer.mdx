...
import practiceCodeSwift from './138-copy-list-with-random-pointer.swift?raw';
import approach1SwiftCode from './138-copy-list-with-random-pointer-approach1.swift?raw';
import approach2SwiftCode from './138-copy-list-with-random-pointer-approach2.swift?raw';
import approach3SwiftCode from './138-copy-list-with-random-pointer-approach3.swift?raw';
...
<Tabs>
  ...
  <TabItem label="Swift">
    <SwiftRepl code={practiceCodeSwift} id="138-copy-list-with-random-pointer-swift" />
  </TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach1SwiftCode} id="138-copy-list-with-random-pointer-approach1-swift" />
</TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach2SwiftCode} id="138-copy-list-with-random-pointer-approach2-swift" />
</TabItem>
</Tabs>
...
<TabItem label="Swift">
  <SwiftRepl code={approach3SwiftCode} id="138-copy-list-with-random-pointer-approach3-swift" />
</TabItem>
</Tabs>
