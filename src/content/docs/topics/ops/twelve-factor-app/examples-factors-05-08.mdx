...
[Factor V: Build, release, run TypeScript source](https://github.com/waggertron/twelve-factor-typescript/blob/v1.0.2/Dockerfile#L1-L17)
  ...
  <TabItem label="Python">
    uv restores the frozen dependency graph and project into one virtual environment. The runtime image copies that environment instead of resolving packages during startup.
...
[Factor V: Build, release, run Python source](https://github.com/waggertron/twelve-factor-python/blob/v1.0.2/Dockerfile#L1-L14)
  ...
  <TabItem label="Go">
    The build compiles one static binary from the locked module graph. The runtime image copies those bytes and contains no Go toolchain or module cache.
